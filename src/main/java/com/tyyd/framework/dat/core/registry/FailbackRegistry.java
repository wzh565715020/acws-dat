...
public abstract class FailbackRegistry extends AbstractRegistry {
	...
	public FailbackRegistry(AppContext appContext) {
		...
		int retryPeriod = appContext.getConfig().getParameter(Constants.REGISTRY_RETRY_PERIOD_KEY,
	...
	protected void retry() {
		...
		if (!failedSubscribed.isEmpty()) {
			...
			for (Map.Entry<Node, Set<NotifyListener>> entry : new HashMap<Node, Set<NotifyListener>>(failed)
					.entrySet()) {
