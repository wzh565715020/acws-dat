package com.tyyd.framework.dat.core.commons.concurrent.limiter;
...
import com.tyyd.framework.dat.core.commons.concurrent.limiter.SmoothRateLimiter.SmoothBursty;
import com.tyyd.framework.dat.core.commons.concurrent.limiter.SmoothRateLimiter.SmoothWarmingUp;
...
public abstract class RateLimiter {
    ...
    public static RateLimiter create(double permitsPerSecond, long warmupPeriod, TimeUnit unit) {
        Assert.isTrue(warmupPeriod >= 0, com.tyyd.framework.dat.core.commons.utils.StringUtils.format("warmupPeriod must not be negative: {}", warmupPeriod));
