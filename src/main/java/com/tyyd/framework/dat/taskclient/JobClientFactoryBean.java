...
public class JobClientFactoryBean implements FactoryBean<TaskClient>,
        InitializingBean, DisposableBean {

	private TaskClient jobClient;
    ...
    @Override
    public TaskClient getObject() throws Exception {
        return jobClient;
    }

    @Override
    public Class<?> getObjectType() {
        return TaskClient.class;
    }
