...
import com.tyyd.framework.dat.jvmmonitor.mbean.JVMGC;
import com.tyyd.framework.dat.jvmmonitor.mbean.JVMInfo;
import com.tyyd.framework.dat.jvmmonitor.mbean.JVMMemory;
import com.tyyd.framework.dat.jvmmonitor.mbean.JVMThread;
...
public class JVMMonitor {
    ...
    private static ReferenceCount getRefCount() {
        try {
            return (ReferenceCount) loadClass("com.tyyd.framework.dat.jvmmonitor.JVMMonitorReferenceCount").newInstance();
        } catch (Throwable e) {

            LOGGER.warn("load com.tyyd.framework.dat.jvmmonitor.JVMMonitorReferenceCount error", e);
