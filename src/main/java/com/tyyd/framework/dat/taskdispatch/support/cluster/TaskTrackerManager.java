...
public class TaskTrackerManager {
    ...
    // 单例
    private final ConcurrentHashMap<String/*nodeGroup*/, Set<TaskExecuterNode>> NODE_MAP = new ConcurrentHashMap<String, Set<TaskExecuterNode>>();
    private TaskDispatcherAppContext appContext;

    public TaskTrackerManager(TaskDispatcherAppContext appContext) {
    ...
    public void addNode(Node node) {
        ...
        TaskExecuterNode taskTrackerNode = new TaskExecuterNode(node.getGroup(),
